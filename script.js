...
addButton.addEventListener('click', function () {
    setTimeout(() => {
        ...
        if (newTab) {
            ...
            // Append CSS and JS files to the new tab
            addFilesToNewTab(newTabDocument);
        } else {
...
function addFilesToNewTab(doc) {
    var cssLink = doc.createElement('link');
    cssLink.rel = 'stylesheet';
    cssLink.type = 'text/css';
    cssLink.href = 'outpages.css';

    var fontAwesomeLink = doc.createElement('link');
    fontAwesomeLink.rel = 'stylesheet';
    fontAwesomeLink.href = 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css';

    var chartScript = doc.createElement('script');
    chartScript.src = 'https://cdn.jsdelivr.net/npm/chart.js';

    var customScript = doc.createElement('script');
    customScript.src = 'outpages.js';

    doc.head.appendChild(cssLink);
    doc.head.appendChild(fontAwesomeLink);
    doc.head.appendChild(chartScript);
...
const notificationSectionPopUps = document.querySelectorAll('.notification-content .notification');



notificationIcon.addEventListener("click", function () {
    if (!notificationContainer.classList.contains("show_notifications")) {
        notificationContainer.classList.add("show_notifications");
    } else {
        notificationContainer.classList.remove("show_notifications");
    }
});
...
notificationSectionPopUps.forEach(function (notification) {
    notification.addEventListener("click", function () {
        ...
        notificationSection.classList.add('activeSettings_section');
        settingsButtons.forEach(function (button) {
